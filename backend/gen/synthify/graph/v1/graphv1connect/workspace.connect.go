...
const (
	...
	WorkspaceServiceAddWorkspaceMemberProcedure = "/synthify.graph.v1.WorkspaceService/AddWorkspaceMember"
)
...
// AddWorkspaceMember calls synthify.graph.v1.WorkspaceService.AddWorkspaceMember.
...
func (UnimplementedWorkspaceServiceHandler) AddWorkspaceMember(context.Context, *connect.Request[v1.AddWorkspaceMemberRequest]) (*connect.Response[v1.AddWorkspaceMemberResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.graph.v1.WorkspaceService.AddWorkspaceMember is not implemented"))
}
